...
('Eiffel Tower', 'A wrought-iron lattice tower on the Champ de Mars in Paris, France. Named after engineer Gustave Eiffel.', 'https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?q=80&w=1000', 4.7, 200, 'Paris, France'),
('Great Wall of China', 'An ancient series of walls and fortifications located in northern China, built around 500 years ago.', 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?q=80&w=1000', 4.9, 180, 'Beijing, China'),

-- Indian Historical Sites
('Hawa Mahal', 'The Palace of Winds is a five-story palace built in 1799, featuring 953 windows and a distinctive honeycomb design.', 'https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=1000', 4.6, 120, 'Jaipur, Rajasthan, India'),
('Amber Fort', 'A majestic fort-palace complex built from red sandstone and marble, featuring stunning architecture and scenic views.', 'https://images.unsplash.com/photo-1565018054866-968e244dd8a8?q=80&w=1000', 4.7, 140, 'Jaipur, Rajasthan, India'),
('Qutub Minar', 'A UNESCO World Heritage site, this 73-meter tall minaret was built in the 12th century and showcases Indo-Islamic architecture.', 'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=1000', 4.5, 110, 'Delhi, India'),

-- Indian Spiritual Sites
('Golden Temple', 'The holiest shrine of Sikhism, known for its stunning golden architecture and spiritual atmosphere.', 'https://images.unsplash.com/photo-1601621915196-2621bfb0cd6e?q=80&w=1000', 4.9, 180, 'Amritsar, Punjab, India'),
('Varanasi Ghats', 'Ancient riverside steps along the Ganges River, central to Hindu spiritual practices and ceremonies.', 'https://images.unsplash.com/photo-1561359313-0639aad49ca5?q=80&w=1000', 4.7, 160, 'Varanasi, Uttar Pradesh, India'),
('Khajuraho Temples', 'Famous for their nagara-style architectural symbolism and erotic sculptures, built between 950-1050 CE.', 'https://images.unsplash.com/photo-1590766740016-10e1910b5042?q=80&w=1000', 4.6, 90, 'Khajuraho, Madhya Pradesh, India'),

-- Indian Natural Wonders
('Valley of Flowers', 'A national park known for its meadows of endemic alpine flowers and variety of flora, located in the West Himalaya.', 'https://images.unsplash.com/photo-1595815771614-ade9d652a65d?q=80&w=1000', 4.8, 85, 'Uttarakhand, India'),
